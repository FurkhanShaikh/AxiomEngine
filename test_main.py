...
from models import AxiomResponse, ConfidenceSummary, TierBreakdown
...
class TestEndpoint:
    ...
    def test_full_pipeline_success(self, mock_llm: MagicMock, client: TestClient) -> None:
        ...
        original_make = __import__("state").make_initial_state
        ...
        with patch("main.make_initial_state", side_effect=patched_make):
    ...
    def test_unanswerable_pipeline(self, mock_llm: MagicMock, client: TestClient) -> None:
        ...
        with patch("main.make_initial_state") as mock_make:
            from state import make_initial_state as real_make
