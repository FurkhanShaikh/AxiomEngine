...
from models import VerificationResult, FinalSentence, Citation
from state import GraphState
from verifier.mechanical import MechanicalVerifier
...
def verification_node(state: GraphState) -> dict[str, Any]:
    ...
    Returns keys: final_sentences, rewrite_requests, loop_count,
                  mechanical_results, audit_trail
    """
    from nodes.semantic import semantic_verifier_node
